...
public class BookingStepsClass {
	...
	@When("I type wrong number for the service number")
	public void iTypeWrongNumberForTheServiceNumber() {
		iHaveFiveServices();
	...
	@Then("I should see this message the service number is wrong")
	public void iShouldSeeThisMessageTheServiceNumberIsWrong() {
		if(scenario1) {
